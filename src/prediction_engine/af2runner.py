...
from user_settings.config import COLABFOLDBATCH_PATH, PREDICTION_ROOT
    ...
    def run_af2(self, parameters: list):
        ...
        for p_set in parameters:
            ...
            command = (
                ...
                f"{self.msa} {os.path.join(PREDICTION_ROOT, result_path, self.prefix)}"
                f"_{max_seq}_{extra_seq}"
            )
            os.system(command)
